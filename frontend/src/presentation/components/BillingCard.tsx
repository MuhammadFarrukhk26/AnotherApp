...
export const BillingCard: React.FC<BillingCardProps> = ({
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title} accessibilityRole="header">Billing & Invoice Summary</Text>
      ...
      <View style={styles.row} accessible={true} accessibilityLabel={`Base Service Fee: ${formatCurrency(baseServiceFee)}`}>
        ...
        <Text style={styles.value}>{formatCurrency(baseServiceFee)}</Text>
      </View>
      ...
      {extraPrice > 0 && (
        <View style={styles.row} accessible={true} accessibilityLabel={`Work Extension: ${formatCurrency(workExtensionFee)}`}>
          <Text style={styles.label}>Work Extension Fee</Text>
          <Text style={styles.value}>{formatCurrency(workExtensionFee)}</Text>
        </View>
      )}
      ...
      <View style={styles.row} accessible={true} accessibilityLabel={`Platform Commission: ${formatCurrency(platformFee)}`}>
        <Text style={styles.label}>Platform Commission (10%)</Text>
      ...
      <View style={styles.paymentMethodContainer}>
        <View style={styles.paymentRow}>
          ...
          <View style={styles.paymentDetails}>
            ...
            <Text style={styles.paymentSub}>{paymentMethod}</Text>
          </View>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent} accessible={true} accessibilityLabel="Detailed Price Breakdown and Invoice Summary">
            
            {/* Modal Header */}
            <View style={styles.modalHeader}>
              <View style={styles.dragHandle} />
              <View style={styles.modalHeaderRow}>
                <Text style={styles.modalTitle} accessibilityRole="header">Detailed Invoice</Text>
                <TouchableOpacity 
            ...
            <ScrollView contentContainerStyle={styles.modalScrollContent}>
              ...
              <View style={styles.receiptContainer}>
                ...
                <Text style={styles.receiptDate}>Booking Invoice Breakdown</Text>
                <View style={styles.receiptDashedDivider} />

                {/* Line Item: Base Service */}
                <View style={styles.receiptRow}>
                  <Text style={styles.receiptLabel}>Base Service Fee</Text>
                  <Text style={styles.receiptValue}>{formatCurrency(baseServiceFee)}</Text>
                </View>

                {/* Line Item: Extra extension if any */}
                {extraPrice > 0 && (
                  <View style={styles.receiptRow}>
                    <Text style={styles.receiptLabel}>Work Extension Fee</Text>
                    <Text style={styles.receiptValue}>{formatCurrency(workExtensionFee)}</Text>
                  </View>
                )}
                ...
                {/* Line Item: Subtotal */}
                <View style={styles.receiptRow}>
                  <Text style={[styles.receiptLabel, styles.semiboldText]}>Net Subtotal</Text>
                  <Text style={[styles.receiptValue, styles.semiboldText]}>{formatCurrency(subtotal)}</Text>
                </View>

                {/* Line Item: Platform Commission */}
                <View style={styles.receiptRow}>
                  <Text style={styles.receiptLabel}>Platform Commission (10%)</Text>
                  <Text style={styles.receiptValue}>{formatCurrency(platformFee)}</Text>
                </View>
              ...
              <View style={styles.promoSection}>
                <Text style={styles.sectionTitle}>Apply Voucher / Promo Code</Text>
                ...
                <Text style={styles.suggestedTitle}>Suggested Deals (Tap to apply):</Text>
                <View style={styles.suggestedList}>
                  {Object.keys(PROMO_CODES).map((code) => {
                    ...
                    return (
                      <TouchableOpacity
                        key={code}
                        style={[styles.suggestedCard, isActive && styles.suggestedCardActive]}
                      ...
                      >
                        ...
                        <Text style={styles.suggestedDescText}>{info.description}</Text>
                      </TouchableOpacity>
                    );
                  })}
                </View>
